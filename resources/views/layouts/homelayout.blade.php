...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('home_assets/assets/assets/img/favicon.png')}}" rel="icon">
    ...
    <style>
        .dropdown-inline {
            ...
            /* match topbar background */
            border: none;
            box-shadow: none;
            padding-left: 1rem;
        }

        .nav-item.dropdown.show .dropdown-inline {
            display: block;
        }
    </style>
...
<body class="index-page">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="skills-grid">
                    ...
                    <div class="skill-item skills-animation" data-aos="fade-up" data-aos-delay="450">
                        ...
                        <p class="skill-description">Designing robust technical foundations that support scalable growth
                            while maintaining security and performance standards.</p>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="cert-content">
                                ...
                                <p class="cert-description">Continuous learning and professional development ensure that
                                    skills remain current with industry standards and emerging technologies.</p>
                                <div class="cert-list">
                                    <div class="cert-item">
                                        <i class="bi bi-award"></i>
                        ...
                        <div class="stats-container">
                            ...
                            <div class="stat-item" data-aos="fade-up" data-aos-delay="100">
                                <div class="stat-content">
                                    ...
                                    <p class="stat-description">Collaborating with industry leaders worldwide to deliver
                    ...
                    <div class="row gy-4 portfolio-grid isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="assets/img/portfolio/portfolio-3.webp" class="img-fluid"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="assets/img/portfolio/portfolio-7.webp" class="img-fluid"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-print">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    ...
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="assets/img/portfolio/portfolio-portrait-5.webp"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-motion">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="assets/img/portfolio/portfolio-8.webp" class="img-fluid"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="assets/img/portfolio/portfolio-9.webp" class="img-fluid"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                            <div class="portfolio-card">
                                <div class="image-container">
                                    <img src="assets/img/portfolio/portfolio-portrait-8.webp" class="img-fluid"
                                        alt="Mobile App Design" loading="lazy">
                                    <div class="overlay">
                                        <div class="overlay-content">
                                            <a href="assets/img/portfolio/portfolio-portrait-8.webp"
                        ...
                        <article class="price-card h-100">
                            <div class="card-head">
                                ...
                                <div class="price-wrap">
                                    <span class="price price-monthly"><sup>$</sup>12<span
                                            class="period">/mo</span></span>
                                    <span class="price price-yearly"><sup>$</sup>120<span
                                            class="period">/yr</span></span>
                                </div>
                            </div>
                        ...
                        <article class="price-card featured h-100 position-relative">
                            ...
                            <div class="card-head">
                                ...
                                <p class="subtitle">Duis aute irure dolor in reprehenderit in voluptate velit esse
                                    cillum.</p>
                                <div class="price-wrap">
                                    <span class="price price-monthly"><sup>$</sup>29<span
                                            class="period">/mo</span></span>
                                    <span class="price price-yearly"><sup>$</sup>290<span
                                            class="period">/yr</span></span>
                                </div>
                            </div>
                        ...
                        <article class="price-card h-100">
                            <div class="card-head">
                                ...
                                <p class="subtitle">Quis autem vel eum iure reprehenderit qui in ea voluptate velit
                                    esse.</p>
                                <div class="price-wrap">
                                    <span class="price price-monthly"><sup>$</sup>59<span
                                            class="period">/mo</span></span>
                                    <span class="price price-yearly"><sup>$</sup>590<span
                                            class="period">/yr</span></span>
                                </div>
                            </div>
    ...
    <script src="{{ asset('home_assets/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')}}"></script>
    ...
    <script>
        function togglebar() {
            ...
            var currentClass = extra_info.getAttribute('class');

            if (currentClass === 'container d-none') {
                extra_info.setAttribute('class', 'container');
            } else {
                extra_info.setAttribute('class', 'container d-none');
            }
        }
    </script>
